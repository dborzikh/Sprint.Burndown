var Gantt = (function () {
    ...
    class Gantt {
        ...
        make_grid_background() {
            ...
            $.attr(this.$svg, {
                height: grid_height + this.options.padding + 0,
                width: '100%'
            });
        }
        ...
        make_dates() {
            for (let date of this.get_dates_to_draw()) {
                let additionalClasses = !!this.options.holidays ? this.options.holidays(date.date) : '';
                let textCssClasses = !!additionalClasses ? 'lower-text ' + additionalClasses.toString() : 'lower-text';
